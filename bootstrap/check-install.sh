...
wait_for_openshift_api() {
    local i=0
    HOST=https://api.${CLUSTER_DOMAIN}:6443/healthz
...
[ -z "$CLUSTER_DOMAIN" ] && echo "🕱 Error: must supply CLUSTER_DOMAIN in env" && exit 1
echo "🌴 CLUSTER_DOMAIN set to $CLUSTER_DOMAIN"
